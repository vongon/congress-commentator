...
const handleDonorName = (str) => {
  var abbrevDict = {
   ...
   'Farmers Group, Inc., Farmers Insurance Exchange, Fire Insurance Exchange And Truck Insurance Exchange Political Action Committee Aka Farmers Insurance Pac': "Farmers Group, Inc.",
